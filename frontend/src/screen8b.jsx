...
import vid from './VIDEOS/screen8b.mp4';
    ...
    <div className="main" style={{ flexDirection: "column" }}>
      ...
      {true && (
        <div style={{ marginTop: '10px', display: 'flex', justifyContent: 'center' }}>
          <button style={buttonStyle} onClick={NavigateToFirstScreen}>
            Prev
          </button>
          <button style={buttonStyle} onClick={NavigateToNextScreen}>
            Next
          </button>
        </div>
      )}
