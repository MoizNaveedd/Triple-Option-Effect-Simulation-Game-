...
import vid from './VIDEOS/screen6.mp4';
...
const Screen6 = () => {
    ...
    const handleNavigationToMCQ =()=>{
        setTimeout(()=>{
            navigate('/Screen-6mcq')
        },1000)
    }
    ...
    return (
        <div className="main" style={{ flexDirection: "column" }}>
            <div className="video" id="s1-video">
                    <ReactPlayer url={vid} style={{minWidth:"100%",minHeight:"100%"}} controls={true} playing={true} onEnded={handleNavigationToMCQ} />
